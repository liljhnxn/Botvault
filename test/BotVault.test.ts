...
describe("BotVault", function () {
  ...
  async function setup() { const [owner, other] = await ethers.getSigners(); const factory = await ethers.getContractFactory("contracts/BotVault.sol:BotVault"); const vault = await factory.deploy() as any; return { vault, owner, other }; }
