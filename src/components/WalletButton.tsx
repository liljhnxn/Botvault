...
export default function WalletButton() {
  ...
  return <div className="flex items-center gap-2">
    {wrongNetwork ? <button onClick={() => switchChain({ chainId: botchain.id })} className="hidden items-center gap-2 rounded-full border border-amber-300/30 bg-amber-200/10 px-3 py-2 text-xs text-amber-200 sm:flex"><Wifi size={14} />Switch network</button> : null}
